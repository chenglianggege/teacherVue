          ...
          <div class="sel-condition" style="display: block">
            <div class="sel-grade">
              <div class="sel-m-box">
                ...
                <ul>
                  <li @click="currentGrade = grade.grade_id" v-for="grade in grades" :key="grade.grade_id" :class="{'li-on' :currentGrade==grade.grade_id}">
...
export default {
  ...
  methods: {
    ...
    async changeLevel (grades) {
      console.log(this.allGrades.grades_info)
  ...
  created () {
    ...
    this.getBookPress()
    this.checkClass()
    this.changeLevel(this.allGrades.grades_info[1])
  },
  mounted () {
    let _this = this
    this.initCart()
